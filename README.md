# Jodi Rhoades Portfolio

## Description

This profile is the start of a learning journey.  Each page shows differnet skill-sets that have been applied from the classes we've had over the last 2 weeks. It is also a great way to learn more about me as a budding develper. 

Each page represents multiple techniques. I'll share the highlights with each.
...
I want to give thanks to all those that helped:
Ryan, Lara, Christian and Jim (my TA's in class).  Also, to my study group buddies, Brock, Tyler and Kacie.  Also, a quick shout out to Thomas and neighboring classmate.  

Youtube and Google are my God-sends but I couldn't begin to tell you what are all the sources I used there.
